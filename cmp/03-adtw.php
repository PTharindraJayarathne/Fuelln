<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    $sqlAdd = "INSERT INTO `towns` (`town_name`) VALUES ('".$name."');";

    if (mysqli_query($conn, $sqlAdd)) {
      $view_message = "Add Town Successful.";

    } else {
        $view_error = "Error >> Can't Add Town.";
    }
  }
?>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header" style="background-color: #ff6a06;">
                <h3 class="card-title">Add Town</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter town" name="town">
                  </div>
                  <button type="submit" name="submit" id="submit" class="btn btn-primary col-12" 
