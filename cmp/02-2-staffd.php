              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter nic">
                  </div>
                  ...
                  style="background-color: #ff6a06; border-color: #ff6a06;">Delete</button>
                </div>
                <!-- /.card-body -->
