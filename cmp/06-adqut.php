<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    $sqlAdd = "INSERT INTO `vehicle_type_quota` (`vehicle_type_id`, `liters`) 
    VALUES ('".$op."', '".$name."') ";

    if (mysqli_query($conn, $sqlAdd)) {
      $view_message = "Add Quota for Vehicle Type Successful.";

    } else {
        $view_error = "Error >> Can't Add Quota for Vehicle Type.";
    }
  }
?>
<!DOCTYPE html>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add Quota for Vehicle Type</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Add Quota for Vehicle Type</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header" style="background-color: #ff6a06;">
                <h3 class="card-title">Add Quota for Vehicle Type</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="" method="post">
                <div class="card-body">
                      ...
                      <?php 
                          ...
                          if (mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                              echo '<option value="'.$row["vehicle_type_id"].'">'.$row["vehicle_type_name"].'</option>';
                            }
                          } else {
                            echo '<option>----</option>';
                          }
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Quota in Liters</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" 
                    placeholder="Enter quota in liters" name="name">
                  </div>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header" style="background-color: #ff6a06;">
                <h3 class="card-title">Vehicle Quota List</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                  ...
                  <table id="tbl1" class="table">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Quota in Liters</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <?php 
                          $sql = "SELECT vehicle_type.vehicle_type_id, vehicle_type_quota.vehicle_quota_id, 
                          vehicle_type.vehicle_type_name, vehicle_type_quota.liters 
                          FROM vehicle_type, vehicle_type_quota 
                          WHERE vehicle_type.vehicle_type_id = vehicle_type_quota.vehicle_type_id; ";
                          $result = mysqli_query($conn, $sql);
