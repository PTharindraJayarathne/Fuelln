<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    $sqlAdd = "INSERT INTO `fuel_stations` (`station_name`, `town_id`, `station_address`) 
    VALUES ('".$name."', '".$tid."', '".$addr."')";

    if (mysqli_query($conn, $sqlAdd)) {
      $view_message = "Add Station Successful.";

    } else {
        $view_error = "Error >> Can't Add Station.";
    }
  }
?>
              ...
              <form action="" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter station" name="stn">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Station Address</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter station address" name="stadd">
                  </div>
                  <div class="form-group">
