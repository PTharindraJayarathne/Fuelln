  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">My Fuel Token(s)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">My Fuel Token(s)</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header" style="background-color: #ff6a06;">
                <h3 class="card-title">My Fuel Token List</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                  ...
                  <table id="tbl1" class="table">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Expects Time Range</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td>FLTK1245625</td>
                        <td>ST001 - Kurunegala</td>
                        <td>KWC - 25XX</td>
                        <td>2023-02-11</td>
                        <td>3:00 PM</td>
                        <td>From 12:00 PM to 6:00 PM</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
