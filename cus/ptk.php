  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Fuel Token Pay</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Fuel Token Pay</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header" style="background-color: #ff6a06;">
                <h3 class="card-title">Fuel Token Pay</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter token number">
                  </div>
                  <button type="submit" class="btn btn-primary col-12" 
                  style="background-color: #ff6a06; border-color: #ff6a06;">View Details</button>

                  <button type="submit" class="btn btn-primary col-12 mt-2" 
                  style="background-color: #ff6a06; border-color: #ff6a06;">Pay</button>
